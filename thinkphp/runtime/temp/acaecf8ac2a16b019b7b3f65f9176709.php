<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/Applications/MAMP/htdocs/thinkphp/public/../application/admin/view/login/index.html";i:1531096812;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="login-container animated fadeInDown">
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="logobox">
                    <p class="text-center">南京审计大学声像档案管理系统</p>
                </div>
        </form>
    </div>
    <!--Basic Scripts-->

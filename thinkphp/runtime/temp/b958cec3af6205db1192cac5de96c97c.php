<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\wamp64\www\thinkphp\public/../application/index\view\index\filelist.html";i:1533052896;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    ...
    <div class="modal-dialog modal-dialog-centered">        
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <audio id="audio_preview" hidden="hidden" src="" controls="controls" controlsList="nodownload"></audio>
            </div>

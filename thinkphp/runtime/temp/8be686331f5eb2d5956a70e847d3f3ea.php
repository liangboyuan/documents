                                ...
                                <div class="widget-body">
                                    <div class="flip-scroll">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                            <?php if(is_array($oper) || $oper instanceof \think\Collection || $oper instanceof \think\Paginator): $i = 0; $__LIST__ = $oper;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$conf): $mod = ($i % 2 );++$i;?>
                                            <tr>
                                                <td align="center"><?php echo $conf['name']; ?></td>
                                                <td align="center"><?php echo $conf['u_name']; ?></td>

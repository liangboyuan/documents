                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="name" value="<?php echo $admin['name']; ?>"  type="text" autocomplete="off">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="password" value="" type="text" autocomplete="off">
                            </div>
                        </div>  
                        <div class="form-group">

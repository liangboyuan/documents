<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\wamp64\www\thinkphp\public/../application/index\view\files\allFiles.html";i:1528695299;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">所有文件（<?php echo $cate; ?>）</h4>
                        </div>
                            ...
                            <table data-toggle="table"  data-striped="true">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input class="btn btn-danger btn-sm" style="border-radius: 0px" type="submit" value="申请下载">
                                        <?php break; case "1": ?>
